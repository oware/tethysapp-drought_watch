...
from .dproducts import EE_PRODUCTS
...
def image_to_map_id(image_name, vis_params={}):
    ...
    """
    try:
        # get igad feature collection
        igad = ee.FeatureCollection("users/allanoware/earegion")
        ee_image = ee.Image(image_name).clip(igad)
...
def get_image_collection_asset(platform, product, date_from=None, date_to=None, reducer='median'):
    """
...
def get_time_series_from_image_collection(platform, product, index_name, scale=30, geometry=None,
